...
export class PaymentsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public paymentsCreatePayment(createPaymentCommand?: CreatePaymentCommand, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<StringApiContract>;
    public paymentsCreatePayment(createPaymentCommand?: CreatePaymentCommand, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<HttpResponse<StringApiContract>>;
    public paymentsCreatePayment(createPaymentCommand?: CreatePaymentCommand, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<HttpEvent<StringApiContract>>;
    public paymentsCreatePayment(createPaymentCommand?: CreatePaymentCommand, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<any> {
        ...
        return this.httpClient.post<StringApiContract>(`${this.configuration.basePath}/v1/payments`,
