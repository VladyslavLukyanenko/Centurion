...
func (f *Fingerprinter) FingerprintClientHello(data []byte) (*ClientHelloSpec, error) {
	...
	for !extensions.Empty() {
		...
		case extensionPSKModes:
			...
			// https://github.com/CenturionLabs/centurion/checkout-service/utls/pull/58#discussion_r522354105
		...
		case extensionApplicationSettings:
			...
			clientHelloSpec.Extensions = append(clientHelloSpec.Extensions, &ALPSExtension{SupportedProtocols: supportedProtocols})
